...
const commands = [
	...
	new SlashCommandBuilder().setName('trade').setDescription('Create a trade offer with someone').addUserOption(option => option.setName('user').setDescription('the user you would like to trade with').setRequired(true)).addStringOption(option => option.setName('your-cards').setDescription('the card(s) you wish to give (comma separated)').setRequired(true)).addStringOption(option => option.setName('their-cards').setDescription('the card(s) you wish to receive (comma-separated) (optional)')),
