...
const commands = [
	...
	new SlashCommandBuilder().setName('user').setDescription('Display all of your owned cards').addUserOption(option => option.setName('user').setDescription('whose cards you would like to see')),
